...
var src_default = {
  async fetch(request, env) {
    if (env.MCP_SERVER === void 0) {
      const server = new MCPServer(null, env);
...
// .wrangler/tmp/bundle-i9uGlK/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-i9uGlK/middleware-loader.entry.ts
